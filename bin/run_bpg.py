...
# -------------------------------------------------------------------------------------------------
# BipartiteGeneral
from PyQuantum.BipartiteGeneral.Cavity import *
from PyQuantum.BipartiteGeneral.Hamiltonian import *

from PyQuantum.BipartiteGeneral.WaveFunction import *
from PyQuantum.BipartiteGeneral.DensityMatrix import *

from PyQuantum.BipartiteGeneral.Evolution import *
# -------------------------------------------------------------------------------------------------
# Common
...
# -------------------------------------------------------------------------------------------------
config = load_pkg("config", "PyQuantum/BipartiteGeneral/config.py")
# -------------------------------------------------------------------------------------------------

mkdir(config.path)
copyfile("PyQuantum/BipartiteGeneral/config.py", config.path + '/config.py')
# -------------------------------------------------------------------------------------------------
